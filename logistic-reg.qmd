...
1.  **Brant test**
    The Brant test is one of the most commonly used tests to check the proportional odds assumption. The `brant` package provides the `brant()` function for this test.

...
::: example
Some researchers used a random sampling method to examine the red blood cell count of 29 normal adults. The measuring results are saved in a `.csv` file. Please analyze its normality.
:::

...
An online version of this book is available at [https://qbgaoo.github.io/r4ms/](#0). It will continue to evolve in between reprints of the physical book. The source of the book is available at <https://qbgaoo.github.io/r4ms/>. The book is powered by [Quarto](#0), which makes it easy to write books that combine text and executable code.
